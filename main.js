...
(function () { // Basically a separate namespace
  ...
  let auto_click_interval = 45 * 1000; // ms between auto screenshot
  ...
  let auto_click_interval_input = null;
  ...
  */
  ...
  function initialize() {
    ...
    auto_click_interval_input = $('auto_click_interval_input')
    auto_click_interval_input.onblur = function () {
            auto_click_interval = parseInt(auto_click_interval_input.value);

    }
    auto_click_interval_input.value = auto_click_interval;
